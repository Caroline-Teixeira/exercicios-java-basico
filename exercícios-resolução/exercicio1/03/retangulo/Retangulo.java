...
public static void main(String[] args) {
    ...
    while (!validEntry1){
        try {
            ...
            if (altura <=0) {
                System.out.println("O número deve ser um número positivo. Tente novamente.");
                continue;
            } else {
                validEntry1 = true;
            }
    ...
    while (!validEntry2){
        try {
            ...
            if (comprimento <=0) {
                ...
                validEntry2 = true;
                System.out.printf("O retângulo de altura %.2f e comprimento %.2f, posssui uma área de %.2f cm\n", altura, comprimento, (altura*comprimento));
            }
        } 
        catch (Exception e) {
            System.out.println("Erro, digite um número válido.");
